    ...
    <Router>
      <div className="App">  {/* Main container for the app */}
        ...
        <Routes>
          ...
          <Route path="/login" element={<Login title="JobSync - Login" setLoggedIn={setLoggedIn} setUserData={setUserData} />} />
          {/* Route for the signup page (using the same Login component for now) */}
          <Route path="/signup" element={<Login title="JobSync - Signup" setLoggedIn={setLoggedIn} setUserData={setUserData} />} />
